      ...
      builder: (context, child) {
        ...
        return BlocBuilder<GroceryListBloc, GroceryListState>(
          buildWhen: (previous, current) =>
              ...
              current.contains(model.id) &&
              current.previousOfId(model.id).boundPrototype?.id != bloc.getItemOfId(model.id, listId).boundPrototype?.id,
          cubit: bloc,
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: BlocBuilder<GroceryListBloc, GroceryListState>(
                                buildWhen: (previous, current) =>
                                    (current is ItemsChangedState && current.previousOfId(model.id)?.tags != bloc.getItemOfId(model.id, listId)?.tags ||
                                        current is ItemTagsListModifiedState && current.listId == listId),
                                cubit: bloc,
                                builder: (context, state) {
